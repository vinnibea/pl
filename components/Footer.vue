...
const paragraphs = [
  ...
  {
    content:
      "Триальный (пробный) период, в течение которого плата не спрашивается с клиента - 5 дней от начала действия подписки. Далее с вашей карты будет списана сумма 3999 тенге за 5 дней использования сервиса (платная подписка).  Подписка автоматически продлевается, если она не была отменена.",
  },
  {
    content:
      "Если вам больше не требуется услуга (вы получили микрокредит или не нуждаетесь в нём), вы можете в любое время -",
    linkContent: "отменить подписку.",
    link: "/cancel",
  },
  {
    content:
