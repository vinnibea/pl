...
<template>
  <div class="flex flex-col justify-between min-h-svh w-full">
    <div class="w-full flex flex-col items-center text-center max-[822px]:items-stretch">
      <div class="pb-4">
        <h2 class="text-green-500 text-[14px] font-semibold uppercase">
            Регистрация завершена
          </h2>
          <p class="font-medium text-sm text-slate-300">Теперь Вы можете воспользоваться услугами одного из следующих кредиторов</p>
      </div>
