  ...
  <div class="flex flex-col justify-stretch w-full">
    <div class="relative w-full max-[822px]:w-full px-0 py-0 group">
      ...
      <input
        ...
        :maxlength="maxLength"
        class="peer px-12 py-2 w-full bg-slate-250 border rounded-md focus:outline-0 bg-slate-50 focus:bg-slate-100 text-slate-700  placeholder:opacity-0 max-[822px]:text-[10px] max-[822px]:focus:text-[10px] max-[822px]:focus:font-bold max-[822px]:focus:uppercase max-[822px]:uppercase max-[822px]:font-bold font-medium max-[822px]:px-12"
        :class="[
          {
